...
// _________________________________EVENTS__________________________________________________________________________



// access where you want put eventlistener
//  Event Listener : addEventListener("types of event", call back function)

// ___________Mouse Event____________
// 1: click : click krne pe react krega
// 2: dblclick : double click krne pe react krega
// 3: mouseover : ek baar mouse ko uske upper se guzzar na hoga tb react krega sirf ek baar
// 4: mousemove: agr choti si bhi movement hui toh har baar react krega
...
// ___________Keyboard Event____________

// 1: keydown: koi bhi keyboard ka button press krenge tb react krega
// 2: keyup: koi bhi keyboard ka button jb press krke chorenge tb hi react krega


// document.addEventListener("keyup", ()=>{ // why i have put event listener in document ? , because my whole webpage is in document only therefore, pura web page pe keyboard se khi bhi click krenge toh react hoga
//     div.innerHTML = lessons[currentIndex];
...
//  ___________Event Object ____________   
// 1: event
// 2: event.target:
// 3: event.type:
// 4: event.key:
...
document.addEventListener("keyup", (event)=>{ // why i have put event listener in document ? , because my whole webpage is in document only therefore, pura web page pe keyboard se khi bhi click krenge toh react hoga
    if(event.key=="Enter"){
