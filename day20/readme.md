...
innerHTML: it will print everything as it is wven tags and elemenst or text 
textContent: it will ignore other elements and tags and print text only, but will also print hidden text(display: none) vale bhi text print krega
innerText:  it will ignore other elements and tags and print text only, but will not  print hidden text(display: none) vale text ko ignore krega bs voi print krega jo actual webpage ki screen pe show hora hoga
